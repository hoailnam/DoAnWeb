                    ...
                    <div class="comments-area">
                        ...
                        for ($i = 0; $i < 5; $i++) {
                            ...
                            if ($i == 0) {
                                ...
                                echo ' <img src="img/blog/c2.jpg" alt=""> ';
                            } elseif ($i == 2) {
                                echo ' <img src="img/blog/c3.jpg" alt=""> ';
                            } elseif ($i == 3) {
                                echo ' <img src="img/blog/c4.jpg" alt=""> ';
                            } elseif ($i == 4) {
                                echo ' <img src="img/blog/c5.jpg" alt=""> ';
                            }

                            echo '</div> ';
                            echo '<div class="desc">';
                            echo '<h5><a href="#">Emilly Blunt</a></h5> ';
                            echo '<p class="date">December 4, 2018 at 3:12 pm </p>';
                            echo '<p class="comment"> 
                                            Never say goodbye till the end come</p> ';
                            echo '</div>';
                            echo '</div> ';
                            echo '<div class="reply-btn">';
                            echo '<a href="" class="btn-reply text-uppercase">reply</a> ';
                            echo '</div>';
                            echo '</div> ';
                            echo '</div>';
                        }
